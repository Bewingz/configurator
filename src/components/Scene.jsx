...
function Label({ children, ...props }) {
  return (
    <Text anchorX="left" {...props} font={suspend(inter).default} letterSpacing={-0.025} lineHeight={0.9} color="black">
      {children}
      <mesh material-color="black" scale={2.5} position={[1.35, 0, 0]} rotation={[0, 0, Math.PI / 4]}>
